...
from .views import LocationUserLoginView, CreateLocationUserView, UpdateUserinformationView # Location User
...
urlpatterns = [
    ...
    path('create-user', CreateLocationUserView.as_view()),
    ...
    path('product/<str:pk>/varients', GetVarientView.as_view(), name='product_id'), # we get all of the varient base on the product
