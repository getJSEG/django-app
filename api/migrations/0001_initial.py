# Generated by Django 4.2.7 on 2025-03-13 02:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('costCenter', models.CharField(blank=True, max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(blank=True, related_name='variantTags', to='api.tags')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paymentMethod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.paymentmethod')),
            ],
        ),
        migrations.CreateModel(
            name='Supplier',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(blank=True, choices=[('OPEN', 'Avierto'), ('CLOSED', 'Cerrado'), ('PAID', 'Pagado'), ('PROCESSING', 'procesando'), ('SHIPPED', 'Enviado'), ('DELIVERED', 'Entregado'), ('CANCELED', 'Cancelado')], default='Avierto', max_length=25, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salesReceipt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.salesreceipt')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expenseType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expenseType', to='api.expensetypes')),
                ('location_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.location')),
            ],
        ),
        migrations.CreateModel(
