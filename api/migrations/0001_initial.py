# Generated by Django 4.2.7 on 2024-02-04 20:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=25)),
                ('status_date', models.DateTimeField()),
                ('item_images', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.images')),
                ('location_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.locations')),
                ...
                ('type_color', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.color')),
            ],
        ),
        migrations.CreateModel(
            name='UserActivity',
