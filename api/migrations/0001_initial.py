# Generated by Django 4.2.7 on 2024-03-17 16:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('location_type', models.CharField(choices=[('WAREHOSUE', 'warehosue'), ('RETAIL', 'retail'), ('DISTRIBUTION_CENTER', 'distributionCENTER')], default='retail', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_date', models.DateTimeField(auto_now_add=True)),
                ('catalog_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.catalogs')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('profit_center', models.CharField(max_length=25)),
                ('order_type', models.CharField(choices=[('RETAIL', 'Retail Store'), ('ONLINE', 'Online')], default='Retail Store', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('varient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.varients')),
            ],
        ),
        migrations.CreateModel(
            name='UserActivity',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_percentage', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=8, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_on', models.DateTimeField(auto_now_add=True)),
                ('status_date', models.DateTimeField(auto_now_add=True)),
                ('avatar', models.ImageField(blank=True, default='user/user.jpeg', upload_to='user')),
